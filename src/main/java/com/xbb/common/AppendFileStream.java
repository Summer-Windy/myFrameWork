...
public class AppendFileStream {
	 ...
	 * @param contenet
	 */
	void appendByBuffer(String filePath,String fileName,String contenet){
	...
	void appendByFileWriter(String filePath,String fileName,String contenet){
	...
	void appendByRandomAccessFile(String filePath,String fileName,String contenet){
